...
namespace NumericExtensions
{
    public class FloatExtensionsTests
    {
        ...
        public void IsDivisibleBy_DivisibleNumbers_True(float f1, float f2)
        {
            var isDivisible = f1.IsDivisibleBy(f2);
        ...
        [InlineData(4, 5)]
        [InlineData(100, 75)]
        public void IsDivisibleBy_NonDivisibleNumbers_False(float f1, float f2)
        {
            var isDivisible = f1.IsDivisibleBy(f2);
