...
namespace NumericExtensions
{
    public class LongExtensionsTests
    {
        ...
        public void IsDivisibleBy_DivisibleNumbers_True(long l1, long l2)
        {
            var isDivisible = l1.IsDivisibleBy(l2);
        ...
        [InlineData(4, 5)]
        [InlineData(100, 75)]
        public void IsDivisibleBy_NonDivisibleNumbers_False(long l1, long l2)
        {
            var isDivisible = l1.IsDivisibleBy(l2);
